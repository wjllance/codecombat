...
#    unit_10_activity_1: "Unit 10 Activity: Web Quiz"
  ...
  parent_landing:
    slogan_quote: "\"CodeCombat 真的很有趣，我学会了编程.\""
#    quote_attr: "5th Grader, Oakland, CA"
    refer_teacher: "分享给老师"
    focus_quote: "成就孩子的未来"
    value_head1: "学习真实代码最互动的方式"
    value_copy1: "CodeCombat 是孩子的个人老师。与国家计算机课程标准一致, 你的孩子将学习编程、算法, 建立网站, 甚至设计自己的游戏。"
    value_head2: "掌握21世纪必备技能"
    value_copy2: "CodeCombat 帮助提高孩子们的逻辑思辨思维和应变能力，教会你的孩子如何在科技世界中入门及成长。"
    value_head3: "孩子们喜欢的卡通人物"
    value_copy3: "趣味和互动对发育中的大脑十分重要, 所以我们把尽可能多的知识融入到每个孩子都喜爱的互动游戏环境中。"
    ...
    dive_head3: "和老师一起组队"
    dive_3_par1: "将来，"
    dive_3_link1: "就像阅读和写作一样，编程会成为一种基本的生活技能"
    dive_3_par2: "。我们与老师密切合作，设计开发最适合孩子们的内容，我们等不及让你的孩子参与进来。像 CodeCombat 这样的教学项目最好是由老师长期进行。帮助我们通过介绍您孩子的老师来建立这种联系!"
    mission: "我们的使命是教学与参与"
    ...
    mission2_copy: "2016年的一项调查显示，3-5年级中64%的女生想学习编程。2015年需要的编码技能相关岗位有700万个。我们创建 CodeCombat 是希望每个孩子都应有机会去创造他们最好的未来。"
    mission3_copy: "在 CodeCombat 中，我们是父母，我们程序员，我们是教育工作者。但最重要的是，我们相信无论孩子们决定做什么，都应该给予他们最好的成功机会。"
